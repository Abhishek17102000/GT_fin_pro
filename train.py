...
def main(cfg):
    ...
    if cfg.TRAIN.PRETRAINED != '' and os.path.isfile(cfg.TRAIN.PRETRAINED):
        ...
        print(f'Error: {cfg.TRAIN.PRETRAINED} is not a pretrained model!')

    vibe_optimizer = get_optimizer(
        model=vibe_model,
    ...
    motion_discriminator_model = MotionDiscriminator(
    ...
    dis_motion_optimizer = get_optimizer(
        model=motion_discriminator_model,
